...
function fileHasFokus() {
  var regex = new RegExp(prepend, 'g');
...
function removeFromHosts() {
  ...
  var write = fs.createWriteStream(hosts);

  input.pipe(split()).pipe(ChopStream).pipe(write);
}
